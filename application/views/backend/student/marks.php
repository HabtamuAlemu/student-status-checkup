...
if (!$student_id) {
    echo '<div class="alert alert-danger">You must be logged in to view your profile.</div>';
    exit;
}
    ...
    <div class="col-md-4">
            ...
            <div class="panel-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><?php echo $age . ' years / ' . date('d M Y', strtotime($student['birthday'])); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="label label-<?php echo ($student['status'] == 1) ? 'success' : 'success'; ?>">
                                <?php echo ($student['status'] == 1) ? 'Registered' : 'Registered'; ?>
                            </span>
                        </td>
                    </tr>
                    <tr>
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body" style="text-align: center;">
                <img src="<?php echo base_url('Uploads/student_image/' . $student['image']); ?>" 
                     class="img-circle" width="150" alt="<?php echo $student['name']; ?>">
            </div>
        </div>
        <?php endif; ?>
    </div>
                                    ...
                                    <div class="panel panel-info">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="alert alert-danger">
                                                ...
                                                <strong>Warning:</strong> You have been absent <?php echo $monthly_absent; ?> times this month.
                                            </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
