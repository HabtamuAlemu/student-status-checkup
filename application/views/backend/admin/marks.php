            ...
            <table class="table table-bordered table-hover table-striped" >
                <thead>
                    <tr>
                        ...
                        <td colspan="2">Assessment 1</td>
                        <td colspan="2">Assessment 2</td>
                ...
                <tbody>
                    ...
                    foreach($students as $row):
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" value="<?php echo $row2['assessment1_obtained'];?>" name="assessment1_obtained" class="form-control" />
                            </td>
                            <td>
                                <input type="number" value="<?php echo $row2['assessment1_total'];?>" name="assessment1_total" class="form-control" />
                            </td>
                            <td>
                                <input type="number" value="<?php echo $row2['assessment2_obtained'];?>" name="assessment2_obtained" class="form-control" />
                            </td>
                            <td>
                                <input type="number" value="<?php echo $row2['assessment2_total'];?>" name="assessment2_total" class="form-control" />
                            </td>
                            <td>
                                <input type="number" value="<?php echo $row2['midterm_obtained'];?>" name="midterm_obtained" class="form-control" />
                            </td>
                            <td>
                                <input type="number" value="<?php echo $row2['midterm_total'];?>" name="midterm_total" class="form-control" />
                            </td>
                            <td>
                                <input type="number" value="<?php echo $row2['final_obtained'];?>" name="final_obtained" class="form-control" />
                            </td>
                            <td>
                                <input type="number" value="<?php echo $row2['final_total'];?>" name="final_total" class="form-control" />
                            </td>
                            <td>
                                <input type="number" value="<?php echo $row2['participation_obtained'];?>" name="participation_obtained" class="form-control" />
                            </td>
                            <td>
                                <input type="number" value="<?php echo $row2['participation_total'];?>" name="participation_total" class="form-control" />
                            </td>
                            <td>
                                <?php echo $row2['mark_obtained'];?> / <?php echo $row2['mark_total'];?>
                            </td>
                            <td>
