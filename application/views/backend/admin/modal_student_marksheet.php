...
foreach ($student_info as $row1):
    ...
    <center>
        ...
        <div class="panel-group joined" id="accordion-test-2">
            ...
            <?php
            /////SEMESTER WISE RESULT, RESULTSHEET FOR EACH SEMESTER SEPARATELY
            $toggle = true;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    foreach ($marks as $row3):
                                                        echo $row3['assessment1_obtained'] . '/' . $row3['assessment1_total'];
                                                    endforeach;
                                                    ?>
                                                </td>
                                                <td>
                                                    <?php
                                                    foreach ($marks as $row3):
                                                        echo $row3['assessment2_obtained'] . '/' . $row3['assessment2_total'];
                                                    endforeach;
                                                    ?>
                                                </td>
                                                <td>
                                                    <?php
                                                    foreach ($marks as $row3):
                                                        echo $row3['midterm_obtained'] . '/' . $row3['midterm_total'];
                                                    endforeach;
                                                    ?>
                                                </td>
                                                <td>
                                                    <?php
                                                    foreach ($marks as $row3):
                                                        echo $row3['final_obtained'] . '/' . $row3['final_total'];
                                                    endforeach;
                                                    ?>
                                                </td>
                                                <td>
                                                    <?php
                                                    foreach ($marks as $row3):
                                                        echo $row3['participation_obtained'] . '/' . $row3['participation_total'];
                                                    endforeach;
                                                    ?>
                                                </td>
                                                <td>
                                                    ...
                                                    foreach ($marks as $row3):
                                                        ...
                                                        $combined_total_marks += $row3['mark_obtained'];
                                                        $current_mark_obtained = $row3['mark_obtained'];
                                                        $current_mark_total = $row3['mark_total'];
                                                        $total_max_marks += $row3['mark_total'];
                                                        $combined_total_max_marks += $row3['mark_total'];
                                                    endforeach;
                                                    ?>
                                                </td>
                                                <td>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            <tr style="font-weight: bold; background-color: #f5f5f5;">
                                <td>
                                    <?php
                                    // Verify all subjects across all semesters have mark_total = 100
                                    $combined_all_subjects_complete = true;
