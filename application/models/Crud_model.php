...
class Crud_model extends CI_Model {
    ...
    function get_active_assessment_methods($semester_id) {
        $this->db->where('is_active', 1);
        $this->db->where('semester_id', $semester_id);
        return $this->db->get('assessment_methods')->result_array();
    }

    function get_all_assessment_methods() {
        return $this->db->get('assessment_methods')->result_array();
    }

    function get_assessment_method($id) {
        $this->db->where('id', $id);
        return $this->db->get('assessment_methods')->row();
    }
