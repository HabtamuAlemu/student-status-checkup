...
function marks($exam_id = '', $class_id = '', $subject_id = '')
{
    ...
    if ($this->input->post('operation') == 'update') {
        // Update all assessment types
        $data = array(
            'assessment1_obtained' => $this->input->post('assessment1_obtained'),
            'assessment1_total' => $this->input->post('assessment1_total'),
            'assessment2_obtained' => $this->input->post('assessment2_obtained'),
            'assessment2_total' => $this->input->post('assessment2_total'),
            'midterm_obtained' => $this->input->post('midterm_obtained'),
            'midterm_total' => $this->input->post('midterm_total'),
            'final_obtained' => $this->input->post('final_obtained'),
            'final_total' => $this->input->post('final_total'),
            'participation_obtained' => $this->input->post('participation_obtained'),
            'participation_total' => $this->input->post('participation_total'),
            'comment' => $this->input->post('comment')
        );
        
        // No need to update mark_obtained or mark_total as they're virtual columns
